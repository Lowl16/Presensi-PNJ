...
import pnj.uas.ti.sandhikaruniasugihartana.BuildConfig
import pnj.uas.ti.sandhikaruniasugihartana.R
import pnj.uas.ti.sandhikaruniasugihartana.utils.BitmapManager.bitmapToBase64
import pnj.uas.ti.sandhikaruniasugihartana.viewmodel.AbsenViewModel
...
class AbsenActivity : AppCompatActivity() {
            ...
            .addOnSuccessListener(this) { location ->
                ...
                if (location != null) {
                    ...
                    Toast.makeText(this@AbsenActivity,
                        "Gagal mendapatkan lokasi. Silahkan periksa GPS atau koneksi internet Anda!",
                    ...
                    override fun onPermissionsChecked(report: MultiplePermissionsReport) {
                        if (report.areAllPermissionsGranted()) {
                            try {
                                ...
                                Toast.makeText(this@AbsenActivity,
                                    "Gagal membuka kamera", Toast.LENGTH_SHORT).show()
                            }
                        }
                    }
        ...
        binding.btnAbsen.setOnClickListener {
            ...
            if (strFilePath.equals(null) || strNama.isEmpty() || strCurrentLocation.isEmpty()
                ...
                absenViewModel.addDataAbsen(
                    ...
                    strKeterangan)
                Toast.makeText(this@AbsenActivity,
                    "Presensi Anda telah terkirim!", Toast.LENGTH_SHORT).show()
                finish()
            }
        }
    }
    ...
    private fun convertImage(imageFilePath: String?) {
        ...
        if (imageFile.exists()) {
            ...
            if (bitmapImage == null) {
                Toast.makeText(this@AbsenActivity,
                    "Foto selfie belum ada!", Toast.LENGTH_LONG).show()
            } else {
